    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- user profile -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.userProfile')" :active="request()->routeIs('dashboard.userProfile')">
                        {{ __('profile') }}
                    </x-nav-link>
                </div>
                ...
                <!-- admin profile -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.adminProfile')" :active="request()->routeIs('dashboard.adminProfile')">
                        {{ __('profile') }}
                    </x-nav-link>
                </div>
                ...
                <!-- Genres -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.genreList')" :active="request()->routeIs('dashboard.genreList')">
                        {{ __('Genres') }}
                    </x-nav-link>
                </div>
